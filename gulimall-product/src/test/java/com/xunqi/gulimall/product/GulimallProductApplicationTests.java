...
import com.xunqi.gulimall.product.vo.Bounds;
...
//        OSS ossClient = new OSSClientBuilder().build(endpoint, accessKeyId, accessKeySecret);
        ...
        // 上传文件流。
        InputStream inputStream = new FileInputStream("/Users/wiley/IdeaProjects/gulimall/gulimall-product/src/main/resources/static/1.txt");
...
//        ossClient.shutdown();
    ...
    public void testSaveSpu() {
        ...
        vo.setBounds(new Bounds());
        vo.setBaseAttrs(null);
        vo.setBrandId(1L);
        vo.setDecript(null);
        vo.setImages(null);
        vo.setCatalogId(1L);
        ...
        vo.setSpuDescription("best thing");
        vo.setWeight(BigDecimal.ONE);
